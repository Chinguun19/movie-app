...
function Popular () {
  ...
  return (
    <div className="text-[20px] text-black mb-[42px] ">
      <h1 className="font-extrabold ml-[20px] mb-[30px] text-[24px] font-[Inter] mt-[10px]">Popular</h1>
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-2 ml-4">
          {movies.slice(0,10).map((movie) => (
            <div key={movie.id} className="rounded-md shadow w-[157.5px] min-h-[309.1px] max-h-fit  bg-[#F4F4F5] text-start">
